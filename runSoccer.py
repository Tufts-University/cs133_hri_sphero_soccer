...
#SPHEROS = ['SB-DADB', 'SB-BD23', 'SB-D2F0', 'SB-74FB']
SPHEROS = ['SB-DADB', 'SB-BD23', 'SB-74FB', 'SB-D2F0']

STRATEGIES = {
	'STRATEGY_R1': {
        'ZONE 1': {
            'SB-DADB': {'heading': 0, 'speed': 0, 'duration': .1},
            'SB-BD23': {'heading': 0, 'speed': 0, 'duration': .1},
            'SB-74FB': {'heading': 0, 'speed': 0, 'duration':  .1},
            'SB-D2F0': {'heading': 0, 'speed': 0, 'duration':  .1}
        },
        'ZONE 2': {
            'SB-DADB': {'heading': 0, 'speed': 0, 'duration':  .1},
            'SB-BD23': {'heading': 0, 'speed': 0, 'duration':  .1},
...
'STRATEGY_R2': {
        'ZONE 1': {
            'SB-DADB': {'heading': 270, 'speed': 0, 'duration': .1},
            'SB-BD23': {'heading': 90, 'speed': 0, 'duration': .1},
            'SB-74FB': {'heading': 270, 'speed': 0, 'duration':  .1},
            'SB-D2F0': {'heading': 90, 'speed': 0, 'duration':  .1}
        },
        'ZONE 2': {
            'SB-DADB': {'heading':270, 'speed': 0, 'duration':  .1},
            'SB-BD23': {'heading': 90, 'speed': 0, 'duration':  .1},
...
'STRATEGY_R3': {
        'ZONE 1': {
            'SB-DADB': {'heading': 90, 'speed': 0, 'duration': .1},
            'SB-BD23': {'heading': 270, 'speed': 0, 'duration': .1},
            'SB-74FB': {'heading': 90, 'speed': 0, 'duration':  .1},
            'SB-D2F0': {'heading': 270, 'speed': 0, 'duration':  .1}
        },
        'ZONE 2': {
            'SB-DADB': {'heading':90, 'speed': 0, 'duration':  .1},
            'SB-BD23': {'heading': 270, 'speed': 0, 'duration':  .1},
    ...
    'STRATEGY_1_NOT_COLOCATED_FORMATION': {
        'ZONE 1': {
            'SB-DADB': {'heading': 180+45, 'speed': 250, 'duration': 0.6*2},
            'SB-BD23': {'heading': 65, 'speed': 250, 'duration': 1.58*2},
            'SB-74FB': {'heading': 180+295, 'speed': 250, 'duration': 1.59*2},
            'SB-D2F0': {'heading': 290, 'speed': 250, 'duration': 0.5*2}
        },
        'ZONE 2': {
            'SB-DADB': {'heading': 180+70, 'speed': 250, 'duration': 1*2},
            'SB-BD23': {'heading': 55, 'speed': 250, 'duration': 1*2},
            'SB-74FB': {'heading': 180+305, 'speed': 250, 'duration': 1*2},
            'SB-D2F0': {'heading': 290, 'speed': 250, 'duration': 1*2}
        },
        'ZONE 3': {
            'SB-DADB': {'heading': 180+84, 'speed': 250, 'duration': 1.5*2},
            'SB-BD23': {'heading': 75, 'speed': 250, 'duration': 0.5*2},
            'SB-74FB': {'heading': 180+280, 'speed': 250, 'duration': 0.6*2},
            'SB-D2F0': {'heading': 276, 'speed': 250, 'duration': 1.32*2}
        }
    },
    'STRATEGY_2_COLOCATED_RANDOM': {
        'ZONE 1': {
            'SB-DADB': {'heading': 180+60, 'speed': 250, 'duration': 1.02},
            'SB-BD23': {'heading': 45, 'speed': 250, 'duration': 1.58},
            'SB-74FB': {'heading': 180+215, 'speed': 250, 'duration': 0.59},
            'SB-D2F0': {'heading': 190, 'speed': 250, 'duration': 1.2}
        },
        'ZONE 2': {
            'SB-DADB': {'heading': 180+70, 'speed': 250, 'duration': 1.12},
            'SB-BD23': {'heading': 85, 'speed': 250, 'duration': 1.58},
            'SB-74FB': {'heading': 180+195, 'speed': 250, 'duration': 1.59},
            'SB-D2F0': {'heading': 90, 'speed': 250, 'duration': 0.32}
        },
        'ZONE 3': {
            'SB-DADB': {'heading': 180+80, 'speed': 250, 'duration': 0.32},
            'SB-BD23': {'heading': 65, 'speed': 250, 'duration': 0.58},
            'SB-74FB': {'heading': 180+295, 'speed': 250, 'duration': 1.19},
            'SB-D2F0': {'heading': 290, 'speed': 250, 'duration': 1.32}
        }
    },
    'STRATEGY_3_COLOCATED_FORMATION': [
        {
            'ZONE 3': {
                'SB-DADB': {'heading': 270, 'speed': 250, 'duration': 1.11},
                'SB-BD23': {'heading': 270, 'speed': 250, 'duration': 0.95},
                'SB-74FB': {'heading': 270, 'speed': 250, 'duration': 0.89},
                'SB-D2F0': {'heading': 270, 'speed': 250, 'duration': 0.85}
            },
            'ZONE 2': {
                'SB-DADB': {'heading': 270, 'speed': 250, 'duration': 1.11},
                'SB-BD23': {'heading': 270, 'speed': 250, 'duration': 0.95},
        ...
        {
            'ZONE 3': {
                'SB-DADB': {'heading': 0, 'speed': 0, 'duration': 0.1},
                'SB-BD23': {'heading': 0, 'speed': 0, 'duration': 0.1},
        ...
        {
            'ZONE 3': {
                'SB-DADB': {'heading': 270, 'speed': 250, 'duration': 0.3},
                'SB-BD23': {'heading': 270, 'speed': 250, 'duration': 0.2},
                'SB-74FB': {'heading': 270, 'speed': 250, 'duration': 0.1},
                'SB-D2F0': {'heading': 270, 'speed': 250, 'duration': 0.05}
            },
            'ZONE 2': {
                'SB-DADB': {'heading': 270, 'speed': 250, 'duration': 0.3},
                'SB-BD23': {'heading': 270, 'speed': 250, 'duration': 0.2},
    ...
    'STRATEGY_4_NOT_COLOCATED_RANDOM': {
        'ZONE 1': {
            'SB-DADB': {'heading': 30, 'speed': 250, 'duration': 1.32},
            'SB-BD23': {'heading': 85, 'speed': 250, 'duration': 1.58},
            'SB-74FB': {'heading': 195, 'speed': 250, 'duration': 1.59},
            'SB-D2F0': {'heading': 210, 'speed': 250, 'duration': 1.32}
        },
        'ZONE 2': {
            'SB-DADB': {'heading': 60, 'speed': 250, 'duration': 1.32},
            'SB-BD23': {'heading': 45, 'speed': 250, 'duration': 1.58},
            'SB-74FB': {'heading': 215, 'speed': 250, 'duration': 1.59},
            'SB-D2F0': {'heading': 190, 'speed': 250, 'duration': 1.32}
        },
        'ZONE 3': {
            'SB-DADB': {'heading': 80, 'speed': 250, 'duration': 1.32},
            'SB-BD23': {'heading': 45, 'speed': 250, 'duration': 1.58},
            'SB-74FB': {'heading': 235, 'speed': 250, 'duration': 1.59},
            'SB-D2F0': {'heading': 220, 'speed': 250, 'duration': 1.32}
        }
    }
}
...
def select_strategy() -> str | None:
    ...
    while True:
        ...
        if key.lower() == 'q':
            return None
        if key.lower() == 'a':
            start_node('device', SPHEROS[0], external_localization=False)
        if key.lower() == 's':
            start_node('device', SPHEROS[1], external_localization=False)
        if key.lower() == 'd':
            start_node('device', SPHEROS[2], external_localization=False)

        if key.lower() == 'f':
            start_node('device', SPHEROS[3], external_localization=False)
...
def start_node(node_type: str, sphero_name: str, external_localization: bool = False) -> subprocess.Popen:
    ...
    Args:
        ...
        sphero_name: Name of the Sphero (e.g., 'SB-DADB')
...
def main():
    ...
    for sphero_name in SPHEROS:
        ...
        time.sleep(10)  # Small delay between node starts
